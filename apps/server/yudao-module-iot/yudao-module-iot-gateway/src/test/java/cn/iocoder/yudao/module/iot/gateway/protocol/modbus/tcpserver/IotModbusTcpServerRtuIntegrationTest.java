...
public class IotModbusTcpServerRtuIntegrationTest {
    ...
    private static final String PRODUCT_KEY = System.getenv("IOT_MODBUS_PRODUCT_KEY");
    private static final String DEVICE_NAME = "modbus_tcp_server_device_demo_rtu";
    private static final String DEVICE_SECRET = System.getenv("IOT_MODBUS_DEVICE_SECRET");
