...
public class IotGatewayDeviceUdpProtocolIntegrationTest {
    ...
    private static final String GATEWAY_PRODUCT_KEY = System.getenv("IOT_GATEWAY_PRODUCT_KEY");
    private static final String GATEWAY_DEVICE_NAME = "sub-ddd";
    private static final String GATEWAY_DEVICE_SECRET = System.getenv("IOT_GATEWAY_DEVICE_SECRET");

    /**
     * 网关设备 Token：从 {@link #testAuth()} 方法获取后，粘贴到这里
     */
    private static final String GATEWAY_TOKEN = System.getenv("IOT_GATEWAY_TOKEN");

    // ===================== 子设备信息（根据实际情况修改，从 iot_device 表查询子设备） =====================
    private static final String SUB_DEVICE_PRODUCT_KEY = System.getenv("IOT_SUB_DEVICE_PRODUCT_KEY");
    private static final String SUB_DEVICE_NAME = "chazuo-it";
    private static final String SUB_DEVICE_SECRET = System.getenv("IOT_SUB_DEVICE_SECRET");
