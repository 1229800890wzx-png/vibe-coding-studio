...
public class IotGatewaySubDeviceCoapProtocolIntegrationTest {
    ...
    private static final String PRODUCT_KEY = System.getenv("IOT_SUB_DEVICE_PRODUCT_KEY");
    private static final String DEVICE_NAME = "chazuo-it";
    private static final String DEVICE_SECRET = System.getenv("IOT_SUB_DEVICE_SECRET");

    /**
     * 网关子设备 Token：从 {@link #testAuth()} 方法获取后，粘贴到这里
     */
    private static final String TOKEN = System.getenv("IOT_SUB_DEVICE_TOKEN");
