...
import cn.iocoder.yudao.module.crm.service.approval.CrmApprovalService;
...
public class CrmReceivableServiceImpl implements CrmReceivableService {
    ...
    @Resource
    private CrmApprovalService approvalService;
    ...
    public void updateReceivableAuditStatus(Long id, Integer bpmResult) {
        ...
        // 2. 更新回款审批状态
        Integer auditStatus = approvalService.toAuditStatus(bpmResult);
    ...
    public void submitReceivable(Long id, Long userId) {
        ...
        // 2. 创建回款审批流程实例
        String processInstanceId = approvalService.createProcessInstance(userId, BPM_PROCESS_DEFINITION_KEY, String.valueOf(id));
