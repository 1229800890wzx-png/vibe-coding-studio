...
public class TradeOrderItemBaseVO {
    ...
    private Long skuId;
    /** Education learner identity; null for ordinary merchandise. */
    private Long studentId;
    private String studentName;
    private String currentCohortName;
    private String enrollmentStatus;
    private String entitlementAction;
    private Integer refundableRemaining;
    private Boolean refundInFlight;
