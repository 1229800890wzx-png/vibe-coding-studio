...
public interface CartMapper extends BaseMapperX<CartDO> {
    ...
    default CartDO selectByUserIdAndSkuId(Long userId, Long skuId) {
        return selectByUserIdAndSkuIdAndStudentId(userId, skuId, null);
    }
    ...
    default CartDO selectByUserIdAndSkuIdAndStudentId(Long userId, Long skuId, Long studentId) {
        return selectOne(new LambdaQueryWrapper<CartDO>()
                .eq(CartDO::getUserId, userId).eq(CartDO::getSkuId, skuId)
                .eq(studentId != null, CartDO::getStudentId, studentId)
                .isNull(studentId == null, CartDO::getStudentId));
    }
