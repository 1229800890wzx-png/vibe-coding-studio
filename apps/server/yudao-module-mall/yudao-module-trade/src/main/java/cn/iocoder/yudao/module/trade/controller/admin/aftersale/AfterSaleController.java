...
public class AfterSaleController {
    ...
    public CommonResult<PageResult<AfterSaleRespPageItemVO>> getAfterSalePage(@Valid AfterSalePageReqVO pageVO) {
        ...
        var response=AfterSaleConvert.INSTANCE.convertPage(pageResult, memberUsers);
        response.getList().forEach(a -> education.afterSale(a.getId(), a));
    ...
    public CommonResult<AfterSaleDetailRespVO> getOrderDetail(@RequestParam("id") Long id) {
        ...
        return success(education.afterSale(id,AfterSaleConvert.INSTANCE.convert(afterSale, order, orderItem, user, logs)));
    }
