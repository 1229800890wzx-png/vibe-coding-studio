...
public class AppAfterSaleCreateReqVO {
    ...
    @Schema(description = "Education entitlement action: KEEP preserves learning; CANCEL cancels learning", example = "CANCEL")
    @jakarta.validation.constraints.Pattern(regexp = "KEEP|CANCEL", message = "学习资格操作只能为 KEEP 或 CANCEL")
    @NotNull(message = "学习资格操作不能为空")
    private String entitlementAction = "CANCEL";
