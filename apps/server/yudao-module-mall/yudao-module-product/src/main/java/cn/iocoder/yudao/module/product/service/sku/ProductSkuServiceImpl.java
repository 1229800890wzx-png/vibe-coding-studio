...
public class ProductSkuServiceImpl implements ProductSkuService {
    ...
    private org.springframework.beans.factory.ObjectProvider<cn.iocoder.yudao.module.product.service.spu.ProductBusinessGuard> businessGuards;
    ...
    public void deleteSku(Long id) {
        ProductSkuDO existing = productSkuMapper.selectById(id);
        if (existing != null) businessGuards.orderedStream().forEach(guard -> guard.beforeCatalogMutation(existing.getSpuId()));
        // 校验存在
    ...
    public void deleteSkuBySpuId(Long spuId) {
        businessGuards.orderedStream().forEach(guard -> guard.beforeCatalogMutation(spuId));
