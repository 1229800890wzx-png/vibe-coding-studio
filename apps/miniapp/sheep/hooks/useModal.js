...
export function showAuthModal(type = 'smsLogin') {
  ...
  if (current.startsWith('pages/edu/') || current.startsWith('pages/tab/') || current.startsWith('pages/pay/')) {
    if (current !== 'pages/edu/login') uni.navigateTo({ url: '/pages/edu/login' });
    return;
  }
