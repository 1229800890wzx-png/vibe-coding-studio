...
export interface ClueVO {
  id: number // 编号
  educationMemberId?: number
  educationStudentId?: number
  educationCourseId?: number
  educationConsentTime?: Date
  educationConsentVersion?: string
  educationServiceType?: 'COURSE' | 'ONE_TO_ONE'
  educationTeacherId?: number
  educationTeacherName?: string
  educationPreferredStartTime?: Date
  educationPreferredEndTime?: Date
  educationAppointmentStatus?: 'REQUESTED' | 'CANCELLED'
  name: string // 线索名称
