...
// This deployment's complete view allowlist. Keep the inactive upstream domains out of Vite's import graph.
// Their source remains in the archive for provenance, including the MES Gantt component.
const modules = import.meta.glob([
  '../views/{Home,Error,IFrame,Login,Profile,Redirect,system,infra,member,mall,pay,edu}/**/*.{vue,tsx}',
  '../views/crm/{clue,followup,permission}/**/*.{vue,tsx}'
])
/**
 * 注册一个异步组件
