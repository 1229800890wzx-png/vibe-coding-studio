...
CREATE TABLE edu_course_version (
  id bigint NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE edu_lesson_template (
  id bigint NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE edu_session_teacher (
  id bigint NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE edu_order_item_ext (
  id bigint NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE edu_transfer_request (
  id bigint NOT NULL AUTO_INCREMENT PRIMARY KEY,
  student_id bigint NOT NULL,
  enrollment_id bigint NOT NULL,
...
CREATE TABLE edu_transfer_event (
  id bigint NOT NULL AUTO_INCREMENT PRIMARY KEY,
  enrollment_id bigint NOT NULL,
  from_cohort_id bigint NOT NULL,
  target_cohort_id bigint NOT NULL,
...
CREATE TABLE edu_growth_report (
  id bigint NOT NULL AUTO_INCREMENT PRIMARY KEY,
  student_id bigint NOT NULL,
  enrollment_id bigint NOT NULL,
  title varchar(255) NOT NULL,
...
CREATE TABLE edu_after_sale_ext (
  id bigint NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE edu_publish_consent (
  id bigint NOT NULL AUTO_INCREMENT PRIMARY KEY,
  work_id bigint NOT NULL,
  version int NOT NULL,
  guardian_member_id bigint NOT NULL,
